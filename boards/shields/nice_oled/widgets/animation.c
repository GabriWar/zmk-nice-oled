...
LV_IMAGE_DECLARE(head_00);
LV_IMAGE_DECLARE(head_01);
LV_IMAGE_DECLARE(head_02);
LV_IMAGE_DECLARE(head_03);
LV_IMAGE_DECLARE(head_04);
LV_IMAGE_DECLARE(head_05);
LV_IMAGE_DECLARE(head_06);
LV_IMAGE_DECLARE(head_07);
LV_IMAGE_DECLARE(head_08);
LV_IMAGE_DECLARE(head_09);
LV_IMAGE_DECLARE(head_10);
LV_IMAGE_DECLARE(head_11);
LV_IMAGE_DECLARE(head_12);
LV_IMAGE_DECLARE(head_13);
LV_IMAGE_DECLARE(head_14);
